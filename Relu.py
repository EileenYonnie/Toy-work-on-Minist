...
class Data:
    ...
    def init_network(self):
        self.W1 = 0.01 * np.random.randn( 28 * 28, 128 )
        self.b1 = 0.01 * np.random.randn( 1, 128 )

        self.W2 = 0.01 * np.random.randn( 128, 64 )
        self.b2 = 0.01 * np.random.randn( 1,   64 )

        self.W3 = 0.01 * np.random.randn( 64, 32 )
        self.b3 = 0.01 * np.random.randn( 1,  32 )

        self.W4 = 0.01 * np.random.randn(32, self.K)
